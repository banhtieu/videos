...
/*
 * This var has to be outside the angularjs factory, otherwise when
...
.factory('$mdUtil', ["$cacheFactory", "$document", "$timeout", "$q", "$window", "$mdConstant", function($cacheFactory, $document, $timeout, $q, $window, $mdConstant) {
  ...
  return Util = {
    ...
    /**
     * nextUid, from angularjs.js.
     * A consistent way of creating unique IDs in angularjs. The ID is a sequence of alpha numeric
...
function mdCompilerService($q, $http, $injector, $compile, $controller, $templateCache) {
   ...
   * @module material.core
   * @description
   * The $mdCompiler service is an abstraction of angularjs's compiler, that allows the developer
      ...
      return {
        ...
        link: function link(scope) {
          ...
          if (controller) {
            ...
            var ctrl = invokeCtrl();
            //See angularjs-route source for this logic
 ...
 * </hljs>
 * <hljs lang="js">
 * var app = angularjs.module('app', ['ngMaterial']);
 ...
 *   e.g. angularjs.element(document.getElementById('content')) or "#content"
 ...
 *
 * @description
 * The checkbox directive is used like the normal [angularjs checkbox](https://docs.angularjs.org/api/ng/input/input%5Bcheckbox%5D).
 *
 * As per the [material design spec](http://www.google.com/design/spec/style/color.html#color-ui-color-application)
 * the checkbox is in the accent color by default. The primary color palette may be used with
 * the `md-primary` class.
 *
 * @param {string} ng-model Assignable angularjs expression to data-bind to.
 ...
 *        var parentEl = angularjs.element(document.body);
 *        $mdDialog.show({
 *          parent: parentEl,
 *          targetEvent: $event,
 *          template:
...
"use strict";
  ...
  /**
    ...
    *
    *     angularjs.forEach(urls, function(url) {
 ...
 *
 * <hljs lang="js">
 * var app = angularjs.module('myApp', ['ngMaterial']);
 ...
 * @restrict E
 *
 * The switch directive is used very much like the normal [angularjs checkbox](https://docs.angularjs.org/api/ng/input/input%5Bcheckbox%5D).
 *
 * As per the [material design spec](http://www.google.com/design/spec/style/color.html#color-ui-color-application)
 ...
 *   <img ng-src="img/angularjs.png" class="centered">
 *   <md-tab
